...
public class Emojigroup {
    ...
    private Emojigroup(String line, String id, String groupId, String subgroupId, String name, int sequence, long lastUpdated, boolean active) {
        this.line = line;
        this.id = id;
    ...
    public static final class Builder {
        ...
        public Emojigroup build() {
            ...
            return new Emojigroup(line,id, groupId, subgroupId, name, sequence, lastUpdated,active);
        }
