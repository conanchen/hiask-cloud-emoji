...
public class Emoji implements Serializable {
    ...
    private Emoji(String line, String codepoint, String codepointu16, String groupId, String subgroupId, String name, int sequence, long lastUpdated, boolean active) {
        this.line = line;
    ...
    public static final class Builder {
        ...
        public Emoji build() {
            ...
            return new Emoji(line,  codepoint,   codepointu16,   groupId,   subgroupId,   name,   sequence,   lastUpdated,   active) ;
        }
