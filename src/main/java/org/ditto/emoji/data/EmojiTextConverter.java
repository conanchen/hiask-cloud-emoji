 ...
 */
@Slf4j
public class EmojiTextConverter {
    ...
    public static void main(String args[]) {
        ...
        processEmojiText(EmojiText.emojiLines);

    }

    public static ArrayList<Object> processEmojiText(String[] lines) {
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            if (groupmatcher.find()) {
                ...
                Emojigroup emojigroup = Emojigroup.builder()
